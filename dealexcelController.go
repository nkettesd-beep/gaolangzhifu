...
type DealexcelController struct {
	BaseController
	DisplayCount int
	CurrentPage  int
	TotalPage    int
...
func (c *DealexcelController)GetScanPayWayCodes()  {
...
func (c *DealexcelController)GetScanPayWayCodesinfo()  {
	menuDataJSON := new(datas.ProDataJSON)
...
func (c *DealexcelController) GetCutPage(l int) {
...
func (c *DealexcelController) GetAccounttody() {
...
//	Msg        string //附加的信息
//}
func (c *DealexcelController) GetAccounttodybug() {
...
func (c *DealexcelController)TestPaycheshi() {
	keyDataJSONv := new(datas.RoadPoolDataJSON)
	var uv Pame
