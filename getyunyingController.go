...
type GetyunyingController struct {
	BaseController
	DisplayCount int
	CurrentPage  int
	TotalPage    int
...
* 处理分页的函数
 */
func (c *GetyunyingController) GetCutPage(l int) {
...
func (c *GetyunyingController) AddMerchant() {
	var u Urole
	json.Unmarshal(c.Ctx.Input.RequestBody, &u)
	merchantName := strings.TrimSpace(u.MerchantName)
	phone := strings.TrimSpace(u.Phone)
	loginPassword := strings.TrimSpace(u.LoginPassword)
	verifyPassword := strings.TrimSpace(u.VerifyPassword)
	merchantStatus := strings.TrimSpace(u.MerchantStatus)
	remark := strings.TrimSpace(c.GetString(u.Remark))
...
func (c *GetyunyingController) GetMenu() {
...
func (c *GetyunyingController) GetFirstMenu() {
	menuDataJSON := new(datas.MenuDataJSON)
...
func (c *GetyunyingController) Getcrollerd() {
...
*获取所有的二级菜单
 */
func (c *GetyunyingController) GetSecondMenu() {
...
func (c *GetyunyingController) GetSecondMenus() {
...
func (c *GetyunyingController) GetOneMenu() {
...
func (c *GetyunyingController) GetPowerItem() {
...
func (c *GetyunyingController) GetRole() {
	//c.AllowCross()
...
func (c *GetyunyingController) GetAllRole() {
	roleInfoDataJSON := new(datas.RoleInfoDataJSON)
...
func (c *GetyunyingController) GetDeployTree() {
...
* 获取操作员列表
 */
func (c *GetyunyingController) GetOperator() {
...
func (c *GetyunyingController) GetOneOperator() {
...
func (c *GetyunyingController) GetEditOperator() {
	userId := strings.TrimSpace(c.GetString("userId"))
...
func (c *GetyunyingController) GetBankCard() {
...
func (c *GetyunyingController) GetOneBankCard() {
...
* 获取通道
 */
func (c *GetyunyingController) GetRoad() {
...
func (c *GetyunyingController) GetAllRoad() {
	roadName := strings.TrimSpace(c.GetString("roadName"))
	params := make(map[string]string)
	params["road_name__icontains"] = roadName
...
* 获取单个通道
 */
func (c *GetyunyingController) GetOneRoad() {
	var u Urole
	json.Unmarshal(c.Ctx.Input.RequestBody, &u)
...
func (c *GetyunyingController) GetRoadPool() {
...
func (c *GetyunyingController) GetAllRollPool() {
...
func (c *GetyunyingController) GetMerchant() {
	...
	merchantDataJSON.Yunyingaccount =yunyingaccounts.GetAccountByMapma(params, c.DisplayCount, c.Offset)
	c.GenerateJSON(merchantDataJSON)
}

func (c *GetyunyingController) GetAllMerchant() {
	merchantDataJSON := new(datas.MerchantDataJSON)
	merchantDataJSON.Code = 200
...
func (c *GetyunyingController) GetOneMerchant() {
...
func (c *GetyunyingController) GetOneMerchantDeploy() {
	merchantNo := strings.TrimSpace(c.GetString("merchantNo"))
	payType := strings.TrimSpace(c.GetString("payType"))
...
func (c *GetyunyingController) GetAllAccount() {
	accountDataJSON := new(datas.AccountDataJSON)
	accountDataJSON.Code = 200

	accountDataJSON.YunyingaccList = yunyingaccounts.GetAllAccountma()

	c.GenerateJSON(accountDataJSON)
}

func (c *GetyunyingController) GetAccountyun() {
	accountName := strings.TrimSpace(c.GetString("agentName"))
	accountUid := strings.TrimSpace(c.GetString("agentId"))

	params := make(map[string]string)
	params["agent_name__icontains"] = accountName
	params["agent_id_icontains"] = accountUid



	l := yunyingaccounts.GetAccountLenByMapma(params)
	c.GetCutPage(l)
	...
	if c.Offset < 0 {
		accountDataJSON.YunyingaccList = make([]yunyingaccounts.MapayInfo, 0)
	...
	accountDataJSON.YunyingaccList = yunyingaccounts.GetAccountByMapma(params, c.DisplayCount, c.Offset)

	c.GenerateJSON(accountDataJSON)
}

func (c *GetyunyingController) GetmacachAccountyun() {
	accountName := strings.TrimSpace(c.GetString("agentName"))
	accountUid := strings.TrimSpace(c.GetString("agentUid"))

	params := make(map[string]string)
	params["agent_name__icontains"] = accountName
	params["agent_uid_icontains"] = accountUid

	l := mauser.GetAccountLenByMapma(params)
	c.GetCutPage(l)

	paramsv := make(map[string]string)
	paramsv["account_name__icontains"] = accountName
	paramsv["account_uid_icontains"] = accountUid
	m := mauser.GetAccountLenByMap(paramsv)
	c.GetCutPage(m)
	...
	if c.Offset < 0 {
		accountDataJSON.Mauseracclist = make([]mauser.MauserInfo, 0)
		c.GenerateJSON(accountDataJSON)
		return
	}

	accountDataJSON.StartIndex = c.Offset
	//accountDataJSON.Mauseracclist = mauser.GetAccountByMap(params, c.DisplayCount, c.Offset)
	accountDataJSON.Yunyingmalist = mauser.GetAccountByMap(paramsv, c.DisplayCount, c.Offset)
	c.GenerateJSON(accountDataJSON)
}

func (c *GetyunyingController) GetAccounttody() {
	...
	accountDataJSON.StartIndex = c.Offset
	accountDataJSON.AccountTody = yunyingaccounts.GetAccountByMaptodyma(params, c.DisplayCount, c.Offset,start,end,accountName)
	c.GenerateJSON(accountDataJSON)
}

func (c *GetyunyingController) GetOneAccount() {
	...
	accountInfo := yunyingaccounts.GetAccountByUidma(accountUid)
	//code初始值为200
	accountDataJSON.Code = 200
	//将从数据库读出来的数据插入到accountList数组中
	accountDataJSON.YunyingaccList = append(accountDataJSON.YunyingaccList,accountInfo)
	//返回jsonp格式的数据给前端
	c.GenerateJSON(accountDataJSON)
}

func (c *GetyunyingController) GetOneyunyingAccount() {
	//从http的body中获取accountUid字段，并且这个字段是string类型
	accountUid := strings.TrimSpace(c.GetString("accountUid"))
	//new一个accountDataJSON结构体对象，用来做jsonp返回
	accountDataJSON := new(datas.AccountDataJSON)
	//用accountuid作为过滤字段，从数据库中读取一条信息
	accountInfo := mauser.GetAccountByUid(accountUid)
	//code初始值为200
	accountDataJSON.Code = 200
	//将从数据库读出来的数据插入到accountList数组中
	accountDataJSON.Yunyingmalist = append(accountDataJSON.Yunyingmalist,accountInfo)
	//返回jsonp格式的数据给前端
	c.GenerateJSON(accountDataJSON)
}

func (c *GetyunyingController) GetAgent() {
...
func (c *GetyunyingController) GetAllAgent() {
	agentName := strings.TrimSpace(c.GetString("agentName"))
	params := make(map[string]string)
...
func (c *GetyunyingController) GetProduct() {
...
func (c *GetyunyingController) GetAgentToMerchant() {
...
* 获取订单数据
 */
func (c *GetyunyingController) GetOrder() {
...
func (c *GetyunyingController) GetOneOrder() {
	bankOrderId := strings.TrimSpace(c.GetString("bankOrderId"))
	orderDataJSON := new(datas.OrderDataJSON)
...
func (c *GetyunyingController) GetOrderProfit() {
	startTime := strings.TrimSpace(c.GetString("startTime"))
	endTime := strings.TrimSpace(c.GetString("endTime"))
	merchantName := strings.TrimSpace(c.GetString("merchantName"))
	agentName := strings.TrimSpace(c.GetString("agentName"))
	...
	listDataJSON.List, counts,success= order.GetOrderProfitByMap(params, c.DisplayCount, c.Offset)
	supplierAll := 0.0
	platformAll := 0.0
	agentAll := 0.0
	allAmount := 0.0
	...
	listDataJSON.Count = counts
	listDataJSON.Successface =success
	listDataJSON.Count, _ = strconv.ParseFloat(fmt.Sprintf("%.3f", counts), 3)
...
func (c *GetyunyingController) GetPayFor() {
	startTime := strings.TrimSpace(c.GetString("startTime"))
	endTime := strings.TrimSpace(c.GetString("endTime"))
...
func (c *GetyunyingController) GetOnePayFor() {
	bankOrderId := strings.TrimSpace(c.GetString("bankOrderId"))
...
func (c *GetyunyingController) GetBalance() {
	/*roadName := strings.TrimSpace(c.GetString("roadName"))
	roadUid := strings.TrimSpace(c.GetString("roadUid"))*/
...
func (c *GetyunyingController) GetNotifyBankOrderIdList() {
	startTime := strings.TrimSpace(c.GetString("startTime"))
	endTime := strings.TrimSpace(c.GetString("endTime"))
	merchantUid := strings.TrimSpace(c.GetString("merchantUid"))
...
* 获取利润表
 */
func (c *GetyunyingController) GetProfit() {
	merchantUid := strings.TrimSpace(c.GetString("merchantUid"))
	agentUid := strings.TrimSpace(c.GetString("agentUid"))
	supplierUid := strings.TrimSpace(c.GetString("supplierUid"))
	payType := strings.TrimSpace(c.GetString("payType"))
...
func (c *GetyunyingController) Getzhuzhuang() {
	var datalist []interface{}
	t := time.Now()
	//firstDay := time.Date(t.Year(), t.Month(), 1, 0, 0, 0, 0, time.UTC).Format("2006-01-02 00:00:00")
	//lastDay := time.Date(t.Year(), t.Month()+1, 1, 0, 0, 0, -1, time.UTC).Format("2006-01-02 00:00:00")
...
* 冻结商户
 */
func (c *GetyunyingController) UpdateMerchantStatus() {

	merchantUid := strings.TrimSpace(c.GetString("merchantUid"))
	keyDataJSON := new(datas.KeyDataJSON)
	if merchantUid == "" {
		keyDataJSON.Code = -1
		keyDataJSON.Msg="操作失败"
		c.GenerateJSON(keyDataJSON)
	}

	merchantInfo := mauser.GetAccountByUidma(merchantUid)

	if merchantInfo.AgentUid == "" {
		keyDataJSON.Code = -1
		keyDataJSON.Msg="操作失败"
		c.GenerateJSON(keyDataJSON)
	}
	...
	if merchantInfo.Status == common.ACTIVE {
		...
		yunyingaccounts.Updatemapayinfo(merchantInfo.AgentUid)
		yunyingaccounts.Updatemapayinfolist(merchantInfo.AgentUid)
	} else {
		merchantInfo.Status = common.ACTIVE
		yunyingaccounts.Updatemapayinfolista(merchantInfo.AgentUid)
	}
	merchantInfo.UpdateTime = utils.GetBasicDateTime()



	if mauser.UpdateAccountma(merchantInfo) {
